...
@Component({
  selector: 'app-boris',
  templateUrl: './boris.component.html',
  styleUrls: ['./boris.component.css']
})
export class BorisComponent implements OnInit {
  firstQuestion = null;
  secondQuestion = null;

  popUpText = "Make sure you have filled both drop boxes";

  borisPageUrl = '../../assets/brexit.png';
  ...
  retrieveData() {
    this.dataService.getBoris().subscribe(
      data => {
        this.tweet=data;
